...
public class Keyword  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this Keyword.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this Keyword.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/NCHS.HIW.DataObjects", "Keyword"));
